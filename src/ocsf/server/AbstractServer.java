...
* @see src.ocsf.server.ConnectionToClient
*/
...
// INSTANCE METHODS *************************************************
  ...
  /**
   * Sends a src.command.message to every client connected to the server.
   ...
   * sending the src.command.message to a particular client is ignored.
   *
   * @param msg   Object The src.command.message to be sent
   */
...
// ACCESSING METHODS ------------------------------------------------
   ...
   * each connection (e.g. kill it, send a src.command.message to it etc.).
