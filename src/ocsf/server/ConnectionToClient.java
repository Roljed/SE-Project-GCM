...
// INSTANCE METHODS *************************************************
   ...
   *
   * @param msg the src.command.message to be sent.
...
// RUN METHOD -------------------------------------------------------
  ...
  final public void run()
  {
    ...
    try
    {
      // The src.command.message from the client
      Object msg;

      while (!readyToStop)
      {
        // This block waits until it reads a src.command.message from the client
