package chat;// This file contains material supporting section 3.7 of the textbook:
...
//    sendToServer("#login ANONYMOUS");
  ...
  public ChatClient(String loginID, String host, int port, ClientConsole clientUI)
    throws IOException 
  {
    super(host, port); //Call the superclass constructor
  ...
  public void handleMessageFromClientUI(String message)
  {
    ...
    else
    {
      ...
      {
        clientUI.display
          ("Could not send src.command.message to server.  Terminating client.");
        quit();
      }
    }
  }
   ...
   * This method handles all data coming from the UI            
   *
   * @param message The object from the UI.    
   */
