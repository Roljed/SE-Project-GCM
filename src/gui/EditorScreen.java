...
public class EditorScreen {
    ...
    private RadioButton updateTourRadioBtn; // Value injected by FXMLLoader V
    ...
    private RadioButton updateContentRadionBtn; // Value injected by FXMLLoader V
    ...
    private RadioButton updateMapRadionBtn; // Value injected by FXMLLoader V
    ...
    private RadioButton addContentToCityRadionBtn; // Value injected by FXMLLoader V
    ...
    private RadioButton addContentToMapRadionBtn; // Value injected by FXMLLoader V

    @FXML // fx:id="updateCity_oldID"
    private TextField updateCity_oldID; // Value injected by FXMLLoader

    @FXML // fx:id="updateCityRadionBtn"
    private RadioButton updateCityRadionBtn; // Value injected by FXMLLoader V

    @FXML // fx:id="addMapToCityRadionBtn"
    private RadioButton addMapToCityRadionBtn; // Value injected by FXMLLoader V
    ...
    private RadioButton addCityRadionBtn; // Value injected by FXMLLoader V
